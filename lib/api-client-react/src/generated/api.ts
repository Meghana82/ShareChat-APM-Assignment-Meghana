 ...
 */
export const getTrends = async (params?: GetTrendsParams, options?: RequestInit): Promise<TrendsApiResponse> => {

  return customFetch<TrendsApiResponse>(getGetTrendsUrl(params),
  {
    ...options,
    method: 'GET'
